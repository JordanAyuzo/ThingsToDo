...
class Server {
    ...
    routes(): void {
        ...
        this.app.post('/decodificarMail', async (req, res) => {
            ...
            try {
                ...
                console.log("decodeco ",decodificado);
                
                const result1 = await this.existeCorreo(decodificado) as any;
    ...
    existeCorreo = (decodificado: any) => {
        return new Promise((resolve, reject) => {
            let consulta = 'SELECT * FROM cliente WHERE nombre="' + decodificado + '"';
